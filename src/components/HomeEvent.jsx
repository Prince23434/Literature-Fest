        ...
        >
          ...
          <div className="flex-shrink-0 w-full flex justify-center relative text-white">
            <img src={homeImg} className="w-[80%] h-[400px] rounded-lg -translate-x-1" />
              <div className="absolute z-[14] top-22 left-23 text-5xl fancy-script1 text-center">Inaugural  <br/>Parade</div>
              <div className="absolute z-[14] bottom-16 text-2xl left-17 fancy-script2 text-center w-[230px]">The grand start of our fest with music and cheers. A fun way to begin the celebration.</div>
          </div>
          <div className="flex-shrink-0 w-full flex justify-center relative text-white">
            <img src={homeImg2} className="w-[80%] h-[400px] rounded-lg" />
              <div className="absolute z-[14] top-20 left-22 text-5xl fancy-script1 text-center">Kavi <br/>Sammelan</div>
              <div className="absolute z-[14] bottom-12 text-2xl left-17 fancy-script2 text-center w-[230px]">An evening of poetry where poets share their heartfelt poetries and shayris. Come listen, smile and enjoy.</div>
          </div>
          <div className="flex-shrink-0 w-full flex justify-center relative text-white">
            <img src={homeImg3} className="w-[80%] h-[400px] rounded-lg translate-x-1" />
              <div className="absolute z-[14] top-20 left-22 text-5xl fancy-script1 text-center">Guest  <br/>Performer </div>
              <div className="absolute z-[14] bottom-26 text-2xl left-17 fancy-script2 text-center w-[230px]"> A special show by a surprise guest. Sit back and enjoy the performance.</div>
          </div>
          <div className="flex-shrink-0 w-full flex justify-center relative text-white">
            <img src={homeImg} className="w-[80%] h-[400px] rounded-lg -translate-x-1" />
              <div className="absolute z-[14] top-20 left-22 text-5xl fancy-script1 text-center">Panel  <br/>Discussion </div>
              <div className="absolute z-[14] bottom-16 text-2xl left-17 fancy-script2 text-center w-[230px]">Talk. Listen. Discuss, thriving topics with writers and speakers. Let's talk it out!!</div>
          </div>
          <div className="flex-shrink-0 w-full flex justify-center relative text-white">
            <img src={homeImg2} className="w-[80%] h-[400px] rounded-lg " />
              <div className="absolute z-[14] top-20 left-30 text-5xl fancy-script1 text-center">Book  <br/>Launch </div>
              <div className="absolute z-[14] bottom-16 text-2xl left-17 fancy-script2 text-center w-[230px]"> See new books being introduced by their authors. A happy moment for every reader.</div>
          </div>
          <div className="flex-shrink-0 w-full flex justify-center relative text-white">
            <img src={homeImg3} className="w-[80%] h-[400px] rounded-lg translate-x-1" />
              <div className="absolute z-[14] top-20 left-32 text-5xl fancy-script1 text-center">Garba <br/>Night </div>
              <div className="absolute z-[14] bottom-16 text-2xl left-17 fancy-script2 text-center w-[230px]">Come witness the feminine devine, with a twist of garba and dandiya in this festive season.</div>
          </div>
        </div>
